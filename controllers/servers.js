let full_data = [
    {
        ...
        "cardHeader": {
            ...
            "imgSrc": "/assets/img/tool-1.png",
            "subtitle1": "S1.4.I14-9.001",
            "subtitle2": "00-024004",
            "status": "В работе",
            "isFavorite": true
        },
        "cardAction-bar": {},
        "cardFilters": {
            "dateAt": "2021-10-07T10:55",
            "dateTo": "2021-10-07T10:55",
            "selectedInterval": 14,
        },
        "cardTableRows": {
            "row1": {
...
let data = [
    ...
    },
    {
        "id": 5,
        "name": "Коагулометр Tcoag, KC 4 Delta",
        "src": "/assets/img/tool-5.png",
        "status": "В работе",
        "noticeStatus": "notice"
    },
    {
        "id": 6,
        "name": "Ещё один прибор...",
        "src": "/assets/img/tool-1.png",
        "status": "Свободен",
        "noticeStatus": "notice"
    },
...
export const getFullCard = (req, res) => {
    res.status(200).json(full_data[req.query.id - 1])
}